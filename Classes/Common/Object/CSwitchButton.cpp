...
void CSwitchButton::setButtonInfo(Node &rootNode, cocos2d::Layer &parent, int level)
{
	...
	_colorBtn[0].setButtonInfo("blue.png", "blue.png", parent, pt, level);
	...
	_colorBtn[1].setButtonInfo("green.png", "green.png", parent, pt, level);
...
//    rootNode.removeChildByName("colory_nl");
	...
	pt = colorBtn->getPosition();
	_colorBtn[2].setButtonInfo("red.png", "red.png", parent, pt, level);
...
//	_defaultColor[3] = Color3B(250, 250, 0);
	_defaultColor[2] = Color3B(250, 0, 0);
	_colorIdx = 0;
}
