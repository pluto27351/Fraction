...
{
private:
    char chiness[9][4] = {{"二"},{"三"},{"四"},{"五"},{"六"},{"七"},{"八"},{"九"},{"十"}};
public:
//    void Input_Que(cocos2d::Node &Q, int number);//∂«√D´¨©M§¿¥Xµ•§¿™∫º∆¶r
//    cocos2d::Node * Set_fraction(const char *numerator, const char *denominator); //•Õ¶®§¿º∆
